...
const DEFAULT_PROMPTS_TEMPLATES = [
  ...
  `Create a professional feature image of a single "[product]" bottle against a clean, solid, pure white background (studio background removed style). Sharp details, natural product shadow below, centered studio composition. Resolution: 300x300 pixels. Square 1:1 aspect ratio. Format: JPG-style compression.`
];
